...
\begin{figure}[htb]
	\centering
	{
		...
		\fbox{\includegraphics[width=\textwidth]{./figures/example-handout-title.pdf}}
	}
...
\begin{figure}[htb]
	\centering
	{
		...
		\setlength{\fboxrule}{2pt}%
		\renewcommand\fbox{\fcolorbox{gray}{white}}
		\fbox{\includegraphics[width=\textwidth]{./figures/example-handout-definition.pdf}}
	}
...
\begin{figure}[htb]
	\centering
	{
		...
		\setlength{\fboxrule}{2pt}%
		\renewcommand\fbox{\fcolorbox{gray}{white}}
		\fbox{\includegraphics[width=\textwidth]{./figures/example-handout-exercise-no-sol.pdf}}
	}
...
\begin{figure}[htb]
	\centering
	{
		...
		\setlength{\fboxrule}{2pt}%
		\renewcommand\fbox{\fcolorbox{gray}{white}}
		\fbox{\includegraphics[width=\textwidth]{./figures/example-handout-exercise-just-sol.pdf}}
	}
